...
// <div className="flex h-[87vh] w-full justify-center items-center">
//   {/*  */}
//   <div className="w-4/3 h-[60vh]  p-8 space-y-3 mb-4  rounded-lg bg-rose-300 text-rose-900">
//     <h1 className="text-2xl font-bold text-center">Login</h1>
...
//     <img src={img} className="rounded-lg h-[60vh]  w-full" />
//   </div>
// </div>
